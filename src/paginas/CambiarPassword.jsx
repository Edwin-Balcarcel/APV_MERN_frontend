...
const CambiarPassword = () => {
  ...
  const handleSubmit = async e => {
    ...
    if(password.pwd_nuevo.length < 6){
      setAlerta({
        msg: 'La contraseña debe tener mínimo 6 carateres',
        error: true
      })
      return;
    }
  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5 mb-40">
          ...
          >
            ...
            <input 
              ...
              className="bg-indigo-600 hover:bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full mt-5" 
            />
          </form>
        </div>
      </div>
